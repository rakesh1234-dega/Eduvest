...
const features = [
  ...
  { icon: Shield, title: "Secure & Private", desc: "Your data is encrypted and fully protected.", gradient: "bg-muted", color: "text-muted-foreground" },
];
  ...
  return (
    <div className={`relative flex flex-col items-center text-center md:px-6 pt-6 md:pt-0 transition-all duration-700 ease-out group ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: `${delay}ms` }}>
      <div className="relative w-36 h-36 flex items-center justify-center mb-6 transition-transform duration-500 group-hover:-translate-y-2">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center bg-white/60 backdrop-blur-md rounded-full w-[100px] h-[100px] shadow-[0_4px_20px_-4px_rgba(99,102,241,0.15)] border border-white group-hover:bg-card group-hover:shadow-[0_4px_25px_-4px_rgba(99,102,241,0.3)] group-hover:scale-105 transition-all duration-500">
          <span className="text-2xl font-extrabold text-foreground tracking-tight transition-colors group-hover:text-indigo-950">
            {prefix}{count === 0 && !inView ? "0" : count.toLocaleString()}{suffix}
          </span>
        </div>
      </div>
      <p className={`text-sm font-semibold text-muted-foreground transition-all duration-700 group-hover:text-foreground uppercase tracking-wider ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-2'}`} style={{ transitionDelay: `${delay + 400}ms` }}>
        {label}
      </p>
    </div>
  );
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#f8fafc] to-[#eef2ff] font-sans text-foreground overflow-x-hidden selection:bg-indigo-500/30 relative">
      ...
      <section className="relative pt-36 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        <div className="absolute inset-0 z-0 pointer-events-none">
          ...
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-2xl h-96 bg-card rounded-full blur-[100px] opacity-80"></div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 grid lg:grid-cols-2 gap-16 items-center">
          <div className="max-w-xl animate-fade-in-up">
            ...
            <p className="text-muted-foreground text-lg lg:text-xl mb-10 leading-relaxed font-medium animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
              ...
              <button className="w-full sm:w-auto bg-white/50 backdrop-blur-sm text-slate-700 text-base font-semibold px-8 py-4 rounded-xl border border-border hover:bg-white/80 transition-all flex items-center justify-center gap-2 shadow-sm">
            ...
            <div className="relative rounded-[2rem] border border-white/60 bg-white/60 backdrop-blur-3xl shadow-2xl p-4 overflow-hidden transform -rotate-2 hover:rotate-0 ring-1 ring-purple-500/20 transition-transform duration-700 ease-in-out">
              ...
              <div className="bg-card rounded-2xl shadow-sm border border-border overflow-hidden">
                ...
                <div className="p-6 bg-muted">
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    <div className="bg-card p-4 rounded-xl shadow-sm border border-border relative overflow-hidden group">
                      ...
                      <div className="text-sm font-semibold text-muted-foreground mb-1">Total Balance</div>
                      <div className="text-2xl font-bold text-foreground">₹12,450</div>
                    </div>
                    <div className="bg-card p-4 rounded-xl shadow-sm border border-border">
                      <div className="text-sm font-semibold text-muted-foreground mb-1">Monthly Spent</div>
                  ...
                  <div className="bg-card p-4 rounded-xl shadow-sm border border-border">
                    ...
                    <div className="space-y-3">
                      {[
                        ...
                        <div key={i} className="flex items-center justify-between p-2 hover:bg-muted rounded-lg transition-colors cursor-pointer">
                          ...
                          <div className={`font-bold text-sm ${tx.amount.startsWith('+') ? 'text-emerald-600' : 'text-foreground'}`}>{tx.amount}</div>
                        </div>
                      ))}
                    </div>
                  </div>
              ...
              <div className="absolute -right-6 -bottom-6 bg-white/90 backdrop-blur-md p-4 rounded-2xl shadow-2xl border border-white/50 flex items-center gap-4 animate-float">
                ...
                <div>
                  ...
                  <div className="text-sm font-bold text-foreground">You saved ₹1,200!</div>
                </div>
              </div>
              ...
              <div className="absolute -left-8 top-12 bg-white/90 backdrop-blur-md px-5 py-3 rounded-2xl shadow-2xl border border-white/50 flex items-center gap-3 animate-float-delayed">
                ...
                <div>
                  ...
                  <div className="text-sm font-extrabold text-foreground">₹12,450</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section ref={statsRef} className="border-y border-border bg-gradient-to-b from-white to-slate-50/50 py-16 relative overflow-hidden">
      ...
      <section id="how-it-works" className="py-24 bg-card">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <h3 className="text-3xl md:text-5xl font-extrabold text-foreground mb-4 tracking-tight">Financial control in 3 steps.</h3>
            <p className="text-muted-foreground text-lg">Managing money shouldn't be harder than your exams. We made it incredibly simple.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 relative">
            ...
            {[
              ...
              <div key={i} className="relative z-10 flex flex-col items-center text-center group">
                <div className="w-24 h-24 rounded-full bg-card border-4 border-white shadow-xl flex items-center justify-center relative mb-6 group-hover:scale-110 transition-transform duration-500">
      ...
      <section id="features" className="py-24 bg-muted">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-extrabold text-foreground mb-4 tracking-tight">Everything you need. Nothing you don't.</h2>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">Powerful features designed around a student's real financial life, packed into a blazing fast interface.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((f, i) => (
              <div key={i} className="bg-card rounded-2xl p-8 border border-border hover:border-indigo-100 hover:shadow-xl hover:shadow-indigo-100/50 transition-all duration-300 group cursor-default">
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          <div className="order-2 lg:order-1 relative">
            ...
            <div className="relative space-y-4">
              <div className="bg-card border border-border shadow-xl rounded-2xl p-5 flex items-start gap-4 transform hover:-translate-y-1 transition-transform">
                <div className="bg-indigo-100 p-2.5 rounded-lg text-indigo-600 mt-1"><Sparkles className="w-5 h-5" /></div>
                <div>
                  <h4 className="font-bold text-foreground">AI Spending Insight</h4>
                  <p className="text-muted-foreground text-sm mt-1">You spent 30% more on Food this week compared to last week. Consider eating at the mess!</p>
                </div>
              </div>
              <div className="bg-card border border-border shadow-xl rounded-2xl p-5 flex items-start gap-4 transform translate-x-8 hover:-translate-y-1 transition-transform">
                <div className="bg-emerald-100 p-2.5 rounded-lg text-emerald-600 mt-1"><CheckCircle2 className="w-5 h-5" /></div>
                <div>
                  <h4 className="font-bold text-foreground">Budget On Track</h4>
                  <p className="text-muted-foreground text-sm mt-1">You have ₹2,400 left for this month. You're doing great pacing your expenses.</p>
                </div>
              </div>
              <div className="bg-card border border-border shadow-xl rounded-2xl p-5 flex items-start gap-4 transform hover:-translate-y-1 transition-transform">
                <div className="bg-amber-100 p-2.5 rounded-lg text-amber-600 mt-1"><BarChart3 className="w-5 h-5" /></div>
                <div>
                  <h4 className="font-bold text-foreground">Payment Habit</h4>
                  <p className="text-muted-foreground text-sm mt-1">UPI is your most used payment method (85% of transactions). Cash withdrawals are unusually high today.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="order-1 lg:order-2 lg:pl-10">
            ...
            <h3 className="text-3xl md:text-5xl font-extrabold text-foreground mb-6 tracking-tight">Your personal financial analyst.</h3>
      ...
      <section id="testimonials" className="py-24 bg-muted">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl md:text-5xl font-extrabold text-foreground mb-16 text-center tracking-tight">Don't just take our word for it.</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-card p-8 rounded-2xl shadow-sm border border-border relative">
                ...
                <p className="text-muted-foreground font-medium leading-relaxed mb-6 relative z-10">"{t.text}"</p>
                <div className="flex items-center gap-3">
          ...
          <div className="relative rounded-[2rem] bg-slate-900 p-12 md:p-20 text-center overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link to="/signup">
                  <button className="w-full sm:w-auto bg-card text-foreground text-base font-bold px-8 py-4 rounded-xl hover:bg-muted transition-all shadow-xl shadow-white/10 flex items-center justify-center gap-2">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
            <div className="col-span-2 lg:col-span-2">
              <div className="flex items-center gap-2.5 mb-4">
                ...
                <span className="font-extrabold text-lg text-foreground">EduVest</span>
              </div>
